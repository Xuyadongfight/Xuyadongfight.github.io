...
## 总览
**图示**
![IMAGE](/assets/images/resources/B4DD5AB9C89C3CB51CF01DB71D1DECC3.jpg)
**一个实际的Mach-O文件**
![IMAGE](/assets/images/resources/32E644F13C778C051565670BA0170B4E.jpg)
...
#### cmd
表示加载命令类型的整数。包含以下:
![IMAGE](/assets/images/resources/095EB09ADC5DBBB47C529D0BEDC62FCC.jpg)
#### cmdsize
...
![IMAGE](/assets/images/resources/1C31B570D6759C4A696EF7024C2D758E.jpg)
...
#### flags
分成两部分的整数。最不重要的8位包含节类型，而最重要的24位包含一组指定节的其他属性的标志。这些类型和标志主要由静态链接器和文件分析工具(如otool)使用，以确定如何修改或显示节。这些是可能的类型:
![IMAGE](/assets/images/resources/B8A7D0CEF001CFEE91DFF14EADF42D7B.jpg)
...
#### n_type
由四个位掩码访问的数据组成的字节值:
![IMAGE](/assets/images/resources/1AF2AFE8658133D14CCC989C8D1249D4.jpg)
#### n_sect
...
一个16位的值，为非插入符号提供关于此符号性质的附加信息。引用标志可以使用REFERENCE_TYPEmask (0xF)访问，定义如下:
 ![IMAGE](/assets/images/resources/611DB50316A6B14C10D47A1CAD012834.jpg)
...
#### n_type
由四个位掩码访问的数据组成的字节值:
 ![IMAGE](/assets/images/resources/2CFB388BE05C6E2F9141EE1A09F4DB1C.jpg)
#### n_sect
一个整数，指定该符号可以在该图像的任何部分中找到，或者NO_SECT(如果该符号没有在此图像的任何部分中找到)。根据区段在LC_SEGMENT加载命令中出现的顺序，区段从1开始连续编号。
#### n_desc
一个16位的值，提供关于此符号性质的附加信息。引用标志可以使用REFERENCE_TYPE掩码(0xF)访问，定义如下:
![IMAGE](/assets/images/resources/D99663DC036EFD8F7A4F2C9D45826397.jpg)
...
指示包含要重新定位的地址的项的长度。下表列出了r_length值和对应的地址长度。
 ![IMAGE](/assets/images/resources/BABFCA475B69E126E923CAC83CF16C4E.jpg)
 
#### r_extern
指示r_symbolnum字段是符号表(1)的索引还是节号(0)。

#### r_type
![IMAGE](/assets/images/resources/94C1C1C7A1727A4E8DE37F4F5453C88E.jpg)
